...
INSERT INTO ATTRIBUTE_CATALOG (CODE, TITLE, DESCRIPTION)
VALUES ('Auth:SP:SAML:Entity:ID', 'Audience URI (SP Entity ID)', NULL);
INSERT INTO ATTRIBUTE_CATALOG (CODE, TITLE, DESCRIPTION) VALUES ('Auth:SP:SAML:EndPoint', 'Single sign on URL', NULL);
INSERT INTO ATTRIBUTE_CATALOG (CODE, TITLE, DESCRIPTION)
VALUES ('Auth:SP:SAML:Encryption:Certificate', 'Encryption Certificate', NULL);
...
INSERT INTO ATTRIBUTE_CATALOG (CODE, TITLE, DESCRIPTION)
VALUES ('Auth:IDP:JOSE:Encryption:Certificate', 'Encryption Certificate', NULL);
