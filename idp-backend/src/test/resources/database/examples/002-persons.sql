...
--changeset ahmed.elidrissi:130 runOnChange:true context:test
UPDATE AUTHENTICATION_INFO_BY_LOGIN
SET AUTHENTICATION_INFO_ID='ENC(qpNlBWLnqklPFcnyMhLpr4VFgFH/Qm3YexC0lqQRUOekyVwzFIW0ma2wr6xSsuvtbaag+g0oRDIOQGOZY/Zm1Ftl1B/idYmKgrhRL4mVwdTYe6Gppezma8+J0PuSQ6E3)'
WHERE ID=0;
