...
INSERT INTO person (id, role_code, external_id, firstname, lastname, birthdate, email, authentication_info_id) VALUES (9000, 'CLIENT', '9000', 'Mly', 'ATTACH', '1984-10-17', 'moulay.attach@gmail.com', 9000);
...
INSERT INTO person (id, role_code, external_id, firstname, lastname, birthdate, email, authentication_info_id) VALUES (9001, 'CLIENT', '9001', 'Fatima', 'EL IDRISSI', '1984-10-17', 'fatima.elidrissi@gmail.com', 9001);