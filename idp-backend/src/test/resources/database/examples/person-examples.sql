...
INSERT INTO PERSON_BY_EMAIL (ID, PERSON_ID, EMAIL) VALUES (110, '9000', 'moul*********@gmail.com');

--changeset ahmed.elidrissi:400 runOnChange:true context:test
...
INSERT INTO PERSON_BY_EMAIL (ID, PERSON_ID, EMAIL) VALUES (111, '9001', 'fatim***********@gmail.com');