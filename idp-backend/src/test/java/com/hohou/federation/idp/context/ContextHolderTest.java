...
import com.hohou.federation.idp.constants.AuthenticationSessionStatus;
...
public class ContextHolderTest {
    ...
    private void then_a_new_auth_session_is_created() {
        ...
        assertThat(contextSession.getStatus(), equalTo(AuthenticationSessionStatus.ACTIVE));
    ...
    private void then_the_first_session_is_closed_and_new_one_is_created(final AuthSession firstSession,
        ...
        assertThat(sessionDAO.findById(firstSession.getId()).get().getStatus(), equalTo(AuthenticationSessionStatus.CLOSED));
    ...
    private void then_the_auth_session_is_closed(final AuthSession authSession) {
        assertThat(sessionDAO.findById(authSession.getId()).get().getStatus(), equalTo(AuthenticationSessionStatus.CLOSED));
