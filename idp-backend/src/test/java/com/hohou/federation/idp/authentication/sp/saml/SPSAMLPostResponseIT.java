...
public class SPSAMLPostResponseIT extends AbstractIntegrationTest {
    ...
    private static final String SECU_EXCP_ATTR = "SPRING_SECURITY_LAST_EXCEPTION";
    private static final String TESTING_IDP_ENTITY_ID = "testingIDP";
    private static final String SP_ENTITY_ID = "primainsure4sgi";
    private static final String SP_ASSERTION_CONSUMER_ENDPOINT = "http://localhost/sp/saml/sso";
    private static final String SP_SSO_ENDPOINT = "/sp/saml/sso";
    ...
    private void given_the_assertion_minimum_valid_attributes() {
        ...
        attributes.add(samlHelper.buildStringAttribute(Claims.CLIENT_ID.getValue(), "9000")); //See 002-persons.sql
        attributes.add(samlHelper.buildStringAttribute(Claims.CLIENT_PROFILE.getValue(), "GP"));
        attributes.add(samlHelper.buildStringAttribute(Claims.ENTITY_ID.getValue(), "BA0000000000001"));
        attributes.add(samlHelper.buildStringAttribute(Claims.ACTION.getValue(), "S"));
    ...
    private void given_the_target_app() {
        final List<Attribute> attributes = attributeStatement.getAttributes();
        attributes.add(samlHelper.buildStringAttribute(Claims.APPLICATION.getValue(), "PolicyDev"));
    }
