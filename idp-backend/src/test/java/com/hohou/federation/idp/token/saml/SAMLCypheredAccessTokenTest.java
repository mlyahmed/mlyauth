...
public class SAMLCypheredAccessTokenTest {
    ...
    private void set_up_attributes() {
        ...
        state = samlHelper.buildStringAttribute(Claims.STATE.getValue(), RandomForTests.randomString());
        scopes = samlHelper.buildStringAttribute(Claims.SCOPES.getValue(), RandomForTests.randomString());
        bp = samlHelper.buildStringAttribute(Claims.BP.getValue(), RandomForTests.randomString());
        delegator = samlHelper.buildStringAttribute(Claims.DELEGATOR.getValue(), RandomForTests.randomString());
        delegate = samlHelper.buildStringAttribute(Claims.DELEGATE.getValue(), RandomForTests.randomString());
