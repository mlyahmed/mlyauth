...
(function(serverside, global, $, _, JSON) {
  if (serverside) {
    _ = require('static/assets/js/underscore');
  }
...
jsonform.elementTypes = {
  ...
  'label' : {
	    'template': '<input type="hidden" ' +
	      ...
	      '<%= (node.schemaElement && node.schemaElement.required && (node.schemaElement.type !== "boolean") ? " required=\'required\'" : "") %>' +
	      '<%= (node.placeholder? "placeholder=" + \'"\' + escape(node.placeholder) + \'"\' : "")%>' +
	      ' /><p style="font-size:15px" ><%= escape(value) %> €</p>',
	    'fieldtemplate': true,
	    'inputfield': true
	  },
	  'label2' : {
  ...
  'ace':{
    ...
    'onInsert': function (evt, node) {
      var setup = function () {
        ...
        // Set the constant of the initial manifest file
  ...
  'array': {
    'template': '<div id="<%= id %>"><ul class="_jsonform-array-ul" style="list-style-type:none;"><%= children %></ul>' +
      '<span class="_jsonform-array-buttons">' +
        '<a href="#" class="btn _jsonform-array-addmore"><div class="icon-plus-sign" title="Add new"></div></a> ' +
        '<a href="#" class="btn _jsonform-array-deletelast"><div class="icon-minus-sign" title="Delete last"></div></a>' +
      '</span>' +
      '</div>',
    'fieldtemplate': true,
    'array': true,
  ...
  'selectfieldset': {
    ...
    'onBeforeRender': function (data, node) {
      ...
      // 1. direct children have IDs (used to show/hide the tabs constant)
...
formNode.prototype.setContent = function (html, parentEl) {
  ...
  if (this.el) {
    // Replace the constant of the DOM element if the node is already in the tree
